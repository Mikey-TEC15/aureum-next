...
const cases = [
  {
    ...
    sector: 'Salud',
    headline: 'De 8 a 22 pacientes nuevos por mes en 90 días.',
    ...
    metrics: [
      { value: '175', suffix: '%', label: 'más citas agendadas' },
      { value: '3.2', suffix: '×', label: 'ROAS final' },
    ],
    dark: false,
  },
  {
  ...
  },
  {
    ...
    body: 'Sistema de lead scoring más WhatsApp automatizado. Reducción del ciclo de venta de 45 a 26 días en promedio. Tasa de cierre casi duplicada.',
    metrics: [
      { value: '42', prefix: '−', suffix: '%', label: 'ciclo de venta' },
      { value: '1.8', suffix: '×', label: 'tasa de cierre' },
    ],
    dark: false,
  },
]
