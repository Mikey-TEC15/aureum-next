...
export default function FloatingWhatsApp() {
  ...
  useEffect(() => {
    const fn = () => setVisible(window.scrollY > window.innerHeight * 0.35)
        ...
        >
          ...
          <AnimatePresence>
            {hovered && (
              ...
              >
                <span
                  className="font-body font-semibold text-white whitespace-nowrap px-4 py-2.5"
                  style={{
                    fontSize: '0.78rem',
          ...
          <a
            ...
            style={{
              ...
              height: 56,
              background: '#25D366',
              boxShadow: '0 4px 20px rgba(37,211,102,0.30), 0 2px 8px rgba(0,0,0,0.35)',
              flexShrink: 0,
            }}
          >
            {/* Slow pulse ring */}
            <motion.span
              ...
              animate={{ scale: [1, 1.42, 1], opacity: [0.35, 0, 0.35] }}
